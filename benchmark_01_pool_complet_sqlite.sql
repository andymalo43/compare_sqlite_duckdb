-- ============================================================================
-- VERSION SQLITE - Adapté pour compatibilité SQLite
-- ============================================================================
-- Ce fichier utilise strftime() au lieu de YEAR() et MONTH()
-- Pour DuckDB, utiliser la version originale sans suffixe _sqlite
-- ============================================================================
...
FROM facture
WHERE strftime('%Y', date_facture) = 2025;
...
FROM facture
WHERE strftime('%Y', date_facture) = 2024 
  AND strftime('%m', date_facture) = 1
  AND statut = 'PAYEE'

UNION ALL SELECT 2, 'Février', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 2 AND statut = 'PAYEE'
UNION ALL SELECT 3, 'Mars', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 3 AND statut = 'PAYEE'
UNION ALL SELECT 4, 'Avril', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 4 AND statut = 'PAYEE'
UNION ALL SELECT 5, 'Mai', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 5 AND statut = 'PAYEE'
UNION ALL SELECT 6, 'Juin', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 6 AND statut = 'PAYEE'
UNION ALL SELECT 7, 'Juillet', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 7 AND statut = 'PAYEE'
UNION ALL SELECT 8, 'Août', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 8 AND statut = 'PAYEE'
UNION ALL SELECT 9, 'Septembre', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 9 AND statut = 'PAYEE'
UNION ALL SELECT 10, 'Octobre', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 10 AND statut = 'PAYEE'
UNION ALL SELECT 11, 'Novembre', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 11 AND statut = 'PAYEE'
UNION ALL SELECT 12, 'Décembre', COUNT(*), SUM(montant_ttc) FROM facture WHERE strftime('%Y', date_facture) = 2024 AND strftime('%m', date_facture) = 12 AND statut = 'PAYEE';
...
INNER JOIN (
    SELECT client_id
    FROM facture
    WHERE statut = 'PAYEE' AND strftime('%Y', date_facture) >= 2024
    GROUP BY client_id
